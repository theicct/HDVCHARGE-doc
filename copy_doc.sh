...
# This script converts the shared HDV CHARGE documentation into the Markdown format
...
echo "========================="
echo "Running this script will update HDV CHARGE's documentation. Before running, confirm that "
...
DOC_SHARED="HDV CHARGE v1.0 Model Documentation.docx"  # the file name of the shared version
...
# Convert to Markdown
echo "-f docx -t gfm --wrap=preserve $DOC_SHARED -o $DOC_RAW"
