"""
Convert the HDV CHARGE documentation from raw Word conversion to Jekyll page format.
...
IMG_MAP = {
    "media/image2.png": "/assets/fig4.png",
    "media/image3.png": "/assets/fig2.png",
}

DOC_RAW = "documentation_raw"
...
def add_front_matter(lines, version):
    ...
    lines.insert(2, f"title: 'HDV CHARGE {version} Documentation'\n")
...
def add_download_button(doc, version):
    ...
    btn = (
        f"<button name='download' onclick=\"location.href='../HDV CHARGE {version} Model "
...
def main():
    ...
    # Remove Word versions' TOC (we'll add Markdown version in at end)
    doc = remove_toc(doc)
